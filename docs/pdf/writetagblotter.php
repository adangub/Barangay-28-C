...
function Footer(){
	...
	// Line break
	$this->Ln(6);
	$this->WriteTag(0,2,'<bpr><n>NELLIEGAR UNCIANO</n></bpr>',0,"R",0,0);
	$this->Ln(2);
	$this->WriteTag(0,2,'<spr><s>Punong Barangay<s></spr>',0,"R",0,0);
	$this->Ln(20);
	
	$this->SetStyle("n","times","none",13,"0,0,0",0);
	$this->SetStyle("s","times","none",11,"0,0,0",0);
	$this->SetStyle("sp","times","none",11,"0,0,0",15);
	$this->SetStyle("spr","times","none",11,"0,0,0",25);
	$this->SetStyle("bpr","times","none",11,"0,0,0",15);
	$this->SetStyle("p","times","none",13,"0,0,0",15);
	$this->SetStyle("pl","times","none",13,"0,0,0",8);
	$this->SetStyle("h1","times","",20,"0,0,0",0);
	$this->SetStyle("u","times","U",0,"0,0,0");
	$this->SetStyle("b","times","B",0,"0,0,0");
	
	$this->WriteTag(0,0,'<n>_________________________</n>',0,"J",0,0);
	$this->Ln(6);
	$this->WriteTag(0,0,'<p>Complainant</p>',0,"J",0,0);
	$this->Ln(6);
	$this->WriteTag(0,0,'<pl>(Name & Signature)</pl>',0,"J",0,0);
	$this->Ln(10);
	$this->WriteTag(0,0,'<n>Received by:  ____________________</n>',0,"J",0,0);
	$this->Ln(6);
	$this->WriteTag(0,0,'<n>Date:              ____________________</n>',0,"J",0,0);
	$this->Ln(6);
	$this->WriteTag(0,0,'<n>Time:             ____________________</n>',0,"J",0,0);
	}	
